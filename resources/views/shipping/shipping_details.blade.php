                                    ...
                                    <div class="tabs-menu1">
                                        ...
                                        <ul class="nav panel-tabs main-nav-line">
                                            <li><a href="#tab4" class="nav-link active" data-toggle="tab">معلومات
                                                    الشحن</a></li>
                                            <li><a href="#tab5" class="nav-link" data-toggle="tab">محتوى الطرد</a></li>
                                                ...
                                                <table class="table table-striped" style="text-align:center">
                                                    <tbody>
                                                        <tr>
                                                            ...
                                                            <td>{{ $shipping->customer->name ?? 'غير معروف' }}</td>
                                                        </tr>
                                                        <tr>
                                                            <th scope="row">نوع الشحن</th>
                                                            <td>{{ $shipping->method->name ?? '' }}</td>
                                                            <th scope="row">قيمة الضريبة</th>
                                                            <td>{{ $shipping->tax_amount }}</td>
                                                            <th scope="row">الاجمالي مع الضريبة</th>
                                                            <td>{{ $shipping->total }}</td>
                                                            <th scope="row">الحالة الحالية</th>
                                                            @if ($shipping->status_value == 1)
                                                                <td><span class="badge badge-pill badge-success">{{ $shipping->status }}</span></td>
                                                            @elseif ($shipping->status_value == 2)
                                                                <td><span class="badge badge-pill badge-danger">{{ $shipping->status }}</span></td>
                                                            @else
                                                                <td><span class="badge badge-pill badge-warning">{{ $shipping->status }}</span></td>
                                                            @endif
                                                        </tr>
                                                        {{-- <tr>
