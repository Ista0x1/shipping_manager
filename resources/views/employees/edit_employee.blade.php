                    ...
                    <form action="{{ route('employees.update', ['employee' => $employee->id]) }}" method="post"
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <label for="inputName" class="control-label">إسم </label>
                                <input type="text" class="form-control" id="inputName" name="name"
                                    title="يرجي ادخال إسم العميل" value="{{$employee->name}}" required>
                            </div>
                            <div class="col">
                                <label for="inputName" class="control-label">رقم الهاتف</label>
                                <input type="text" class="form-control" id="inputName" name="phone"
                                    title="يرجي إدخال رقم الهاتق" value="{{$employee->phone}}">
                            </div>
                            <div class="col">
                                ...
                                <input type="email" class="form-control" id="inputName" name="email"
                                    title="يرجي ادخال البريد الإلكتروني" value="{{$employee->email}}" >
                            </div>
                        </div>
                        <div class="row">
                            <div class="col">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                ...
                                <input type="number" class="form-control" id="inputName" name="salary"
                                    title="يرجي ادخال عنوان العميل" value="{{$employee->salary}}" >
                            </div>
                        </div>
