...
@section('page-header')
				...
				<div class="breadcrumb-header justify-content-between">
					<div class="my-auto">
						<div class="d-flex">
							<h4 class="content-title mb-0 my-auto">الموظفين</h4><span class="text-muted mt-1 tx-13 mr-2 mb-0">/جميع الموظفين</span>
						</div>
					</div>
                                        ...
                                        <table id="example1" class="table key-buttons text-md-nowrap">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th class="border-bottom-0">الدور الوظيفي</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                <td><a href="{{route('employees.show',$item->id)}}">{{$item->id}}</a></td>
                                                <td>{{$item->name}}</td>
                                                <td>{{$item->phone}}</td>
                                                <td>{{$item->email}}</td>
                                                <td>{{$item->position}}</td>
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu tx-13">
                                                                ...
                                                                <a class="dropdown-item"
                                                                    ...
                                                                    class="text-warning fas fa-pen"></i>&nbsp;&nbsp;تعديل
                                                                الموظف</a>
                        ...
                        <div class="modal-dialog" role="document">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <input type="hidden" name="employee_id" id="customer_id" value="">
                                </div>
